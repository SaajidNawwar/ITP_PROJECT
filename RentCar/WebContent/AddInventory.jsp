...
glyphicon glyphicon-log-out"></span>
			...
			<div class="col-md-8 col-xl-9" style="width:75%;">
				<div class="card" style="height: 1000px;">
					<div class="card-header">
						<h5 class="card-title mb-0"><span class="glyphicon glyphicon-plus "></span> Add Inventory</h5>
...
<p><img id="output" width="200" height="200" /> 
...
<div class="form-group">
  ...
  <div class="col-md-6">
  <input id="carID" name="cardid" placeholder="Car ID" class="form-control input-md" required="" type="text">
...
<div class="form-group">
  <label class="col-lg-2 col-lg-offset-2 control-label" for="product_categorie">Category</label>
  <div class="col-md-6">
...
<div class="form-group">
  <label class="col-lg-2 col-lg-offset-2 control-label" for="available_quantity">Supplier ID</label>  
  <div class="col-md-6">
  <input id="sup_ID" name="supid" placeholder="Supplier ID" class="form-control input-md" required="" type="text">
...
<div class="form-group">
  ...
  <div class="col-md-6">
  <input id="num_of_pass" name="noOfpass" placeholder="No Of Passengers" class="form-control input-md" required="" type="number">
...
<div class="form-group">
  ...
  <div class="col-lg-5 col-lg-offset-5">
    <button id="addbutton" name="addbutton" class="btn btn-primary" type="submit">Add Inventory</button>
  </div>
  </form>
 </div>
