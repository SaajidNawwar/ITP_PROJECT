				...
				<div class="card" style="height: 1000px;">
					<div class="card-header">
						...
						<form class="form-container" action="UpdateRateServlet?RateId=<%=rate.getRateId()%>" method="post">
							...
							<label>rateid</label>
						<input disabled="disabled" class="form-control" id="exampleInputFName" placeholder="Event Name"  name="RateId"    value="<%=rate.getRateId()%>"        >
						<br>
						...
						<input type="text" class="form-control" id="exampleInputPassword1" placeholder="Event cost"  name="Amount" value="<%=rate.getAmount()%>"     ><br>
								...
								<input type="submit"  value="Update" class="btn btn-success " style="margin-left: 500px;background-color: #8080ff;">
