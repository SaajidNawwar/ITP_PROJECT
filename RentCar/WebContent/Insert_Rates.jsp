		  ...
		  <tr>
			...
			%>
			 ...
			 <tr>
				...
				<td><a href="update_Rates.jsp?RateId=<%=rates.getRateId() %>"><button style="background-color: #8080ff;" class="btn btn-success " >Update</button></a></td>
										
				<td><form method="POST" action="DeleteRateServlet?RateId=<%=rates.getRateId() %>"><button style="background-color: #8080ff;" class="btn btn-success ">Delete</button></form></td>
            ...
            %>     
					...
					<form class="form-container" action="AddRateServlet" method="post"
						...
						<label>Amount</label> <input type="number" class="form-control"
							...
							required><br>
							 <input type="submit"	class="btn btn-success " value="ADD" style="margin-left: 500px;background-color: #8080ff;"><br>
