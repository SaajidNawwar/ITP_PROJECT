						...
						<div class="card-body text-center">
							<div>
								<nav class='animated bounceInDown'>
									<ul>
										<li class='sub-menu'><a href='#'>IncomeStatement<div class='fa fa-caret-down right'></div></a>
										<ul>
					...
					<table border="1" cellpadding="12" class="table table-hover">
						...
						<tbody>
							<tr>
								...
								<td><a	href="Display_incom_ststement.jsp?date=<%=IS.getDate()%>"><button style="background-color: #8080ff;" class="btn btn-success ">VIEW</button></a></td>
							</tr>
						</tbody>
						<%
							}
